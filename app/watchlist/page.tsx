      ...
      <div className="container-tv">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 px-6 flex flex-col items-center justify-center bg-white/[0.02] border border-white/5 rounded-3xl backdrop-blur-md shadow-2xl max-w-md mx-auto">
            <div className="w-16 h-16 rounded-full bg-yellow-500/10 flex items-center justify-center mb-5 text-2xl border border-yellow-500/20 text-yellow-500 shadow-[0_0_20px_rgba(234,179,8,0.15)]">
              ★
            </div>
