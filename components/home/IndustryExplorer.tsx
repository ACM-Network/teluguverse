...
const INDUSTRIES = [
  {
    ...
    nameTe: 'టాలీవుడ్',
    desc: 'Telugu Cinema',
    href: '/search?type=MOVIE&language=Telugu',
    color: '#FFD700',
  ...
  },
  {
    ...
    nameTe: 'బాలీవుడ్',
    desc: 'Hindi Cinema',
    href: '/search?type=MOVIE&language=Hindi',
    color: '#F43F5E',
  ...
  },
  {
    ...
    nameTe: 'కొలీవుడ్',
    desc: 'Tamil Cinema',
    href: '/search?type=MOVIE&language=Tamil',
    color: '#06B6D4',
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
        {INDUSTRIES.map((industry, i) => (
          ...
          >
            ...
            >
              {/* Pattern artwork */}
              <div className="absolute inset-0 group-hover:opacity-[0.2] transition-opacity duration-500">
                {industry.pattern(industry.color)}
              </div>

              {/* Top glow */}
              <div
                className="absolute top-[-20px] left-1/2 -translate-x-1/2 w-28 h-28 rounded-full blur-3xl opacity-15 group-hover:opacity-35 transition-opacity duration-500"
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, rgba(7,8,16,0.97) 0%, rgba(7,8,16,0.7) 50%, transparent 100%)',
                }}
              />

              {/* Industry name */}
              <div className="relative z-20 p-4 pb-5 text-center w-full">
                ...
                <p className="text-gray-500 text-[9px] font-semibold font-rajdhani tracking-wider uppercase mt-1">
                  {industry.desc}
                </p>
              </div>
              ...
              {/* Bottom accent */}
              <div
                className="absolute bottom-0 left-0 right-0 h-[2px] translate-y-[2px] group-hover:translate-y-0 transition-transform duration-300 z-20"
                style={{ background: industry.color }}
              />
