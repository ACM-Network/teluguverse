  ...
  const universesData = [
    {
      ...
      description: 'The world\'s largest interconnected superhero saga, mapping the Infinity Quest and Multiverse eras across blockbusters and streaming series.',
      color: '#E50914',
    },
    {
      id: 'dc',
      name: 'DC Universe',
      nameTe: 'DC యూనివర్స్',
      description: 'A saga of legendary heroes and complex villains, from the gothic streets of Gotham to the cosmic heights of Metropolis.',
      color: '#00A8E0',
    },
    {
      id: 'baahubali',
      ...
      description: 'SS Rajamouli\'s groundbreaking cinematic mythology, tracing the legacy of royal betrayal, honor, and war in the kingdom of Mahishmati.',
      color: '#F59E0B',
    },
    {
      id: 'onepiece',
      ...
      description: 'Eiichiro Oda\'s record-breaking pirate epic, tracing Monkey D. Luffy\'s search for the ultimate treasure and freedom across the Grand Line.',
      color: '#A855F7',
    },
    {
      id: 'monsterverse',
      ...
      description: 'A titan-scale clash of cinematic giants, tracing the origins of Godzilla, Kong, and the ancient Monarch organization.',
      color: '#22C55E',
    },
    {
      id: 'naruto',
      ...
      nameTe: 'నరుటో విశ్వం',
      description: 'Masashi Kishimoto\'s definitive ninja masterpiece, following Naruto Uzumaki\'s journey from a shunned outcast to the legendary Hokage of the Leaf.',
      color: '#FF8C00',
    },
    {
      id: 'lcu',
      ...
      description: 'Lokesh Kanagaraj\'s gritty, dark-themed drug cartel saga, seamlessly weaving the stories of Kaithi, Vikram, and Leo.',
      color: '#06B6D4',
    }
  ]
